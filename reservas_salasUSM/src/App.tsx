...
function AppLayout() {
  ...
  // Determinar si estamos en una ruta de edificio o sala
  const isInBuildingOrRoom = currentPath.includes('/building/');

  return (
    <div className="min-h-screen bg-background">
      {/* Header con fondo degradado - Solo mostrar en rutas principales */}
      {!isInBuildingOrRoom && (
